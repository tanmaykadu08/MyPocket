# MyPocket — Money Manager Backend
...
git remote add origin https://github.com/YOUR_USERNAME/mypocket-backend.git
...
Your app URL will be: `https://mypocket-backend.onrender.com`
